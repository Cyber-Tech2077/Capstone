...
<?php
	include ("./php/new_headernav.html");
        ...
        $(document).ready(function() {
            $("#update_pet").click(function() {
                ...
                $.post({
				    ...
				    pet_state: document.getElementById("state_id").value, pet_zip: document.getElementById("zip_id").value, pet_ID: idNum.options[idNum.selectedIndex].id.toString()},
